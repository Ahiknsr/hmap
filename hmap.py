...
class request:
    ...
    def __init__(self, url, method='GET', local_uri='/', version='1.0'):
        ...
        self.headers = [['User-Agent', 'Mozilla\/4.75 [en] (Windows NT 5.0; U)']]
        self.line_joiner = '\r\n'
        self.body = ''
...
class response:
    ...
    def __parse(self,text):
        ...
        # TODO: make sure this only checks first line
...
###################################################################### 
# "MAIN" 
opts, args = getopt.getopt(sys.argv[1:],'pghvc:')
prefetched = None
GATHER_ONLY = 0
VERBOSE = 0
MATCH_COUNT = 5
